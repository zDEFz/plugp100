...
class LightEffectData:
    ...
    hue_range: Optional[int] = None
    init_states: List[List[int]] = dataclasses.field(default_factory=list)
    random_seed: Optional[int] = None
    repeat_times: Optional[int] = None
    saturation_range: List[int] = dataclasses.field(default_factory=list)
    segment_length: Optional[int] = None
    segments: List[int] = dataclasses.field(default_factory=list)
    sequence: List[List[int]] = dataclasses.field(default_factory=list)
    spread: Optional[int] = None
    transition: Optional[int] = None
    transition_range: List[int] = dataclasses.field(default_factory=list)
