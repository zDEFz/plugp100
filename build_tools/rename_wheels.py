...
if __name__ == "__main__":
    ...
    for generated_wheel_name in generated_wheel_names:
        new_wheel_name = re.sub(wheel_regex, rf'\1\2\3\4{platform_name}\6.whl', generated_wheel_name)
        os.rename(os.path.join('dist/', generated_wheel_name), os.path.join('dist/', new_wheel_name))
